<?php //fichier public/particuliers.php
...
<html lang="fr">
<head>
    <title>Particuliers | Les Compagnons du Compost</title>
    <?php include('asset/includes/head.php');
    ?>
    <meta name="description" content="Les Compagnons du composta accompagnent les particuliers dans leurs démarches de compostage avec un suivi personnalisé">
</head>
<body>
<!----HEADER---->
    <header>
...
<!----MAIN---->
    <main>
        ...
        <div class="row">
            <h1 class="col-12 display-2 mb-3 display-3 text-center margin-title align-self-center titre">Particuliers</h1>
        ...
        <div class="container mb-5">
            <div class="page-header">
                ...
                <p class = "col-12 mt-4">Nous vous accompagnons pour mettre en place des composteurs de proximité ou en pied d’immeuble</p>
            </div>
            <ul class="timeline">
                <li>
                    ...
                    <div class="timeline-panel"><!- bloc a gauche->
                        <div class="timeline-heading">
                            <h4 class="timeline-title">Premiers échanges </h4>
                        </div>
                        <div class="timeline-body">
                            <p>Échange pour définir où vous en êtes dans la démarche et vous conseillez</p>
                        </div>
                    </div>
                </li>
                <li class="timeline-inverted"><!- bloc a droite->
                    ...
                    <div class="timeline-panel">
                        ...
                        <div class="timeline-body">
                            <p>Rencontre gratuite avec votre syndicat de copropriété, votre bailleur ou votre ville en fonction de l’avancée du projet</p>
                        </div>
                    </div>
                </li>
                <li>
                    ...
                    <div class="timeline-panel">
                        <div class="timeline-heading">
                            <h4 class="timeline-title">"Mise en route"</h4> <!-- A VERIFIER !-->
                        </div>
                        <div class="timeline-body">
                            <p>Devis adressé à votre syndicat de copropriété ou votre bailleur</p>
                        </div>
                    </div>
                </li>
                <li class="timeline-inverted"><!- bloc a droite->
                    ...
                    <div class="timeline-panel">
                        ...
                        <div class="timeline-body">
                            <p>De l’évaluation du volume de biodéchets compostés à la préconisation du matériel adapté</p>
                        </div>
                    </div>
                </li>
                <li>
                    ...
                    <div class="timeline-panel">
                        <div class="timeline-heading">
                            <h4 class="timeline-title">Mise en place</h4> <!-- A VERIFIER !-->
                        </div>
                        <div class="timeline-body">
                            <p>Accompagnement des volontaires lors d’une réunion d’information et un suivi chaque semaine pendant un mois pour valider ensemble l’avancée du compost.</p>
                        </div>
                    </div>
                </li>
                <li class="timeline-inverted"><!- bloc a droite->
                    ...
                    <div class="timeline-panel">
                        <div class="timeline-heading">
                            <h4 class="timeline-title">Suivi annuel</h4>
                        </div>
                        <div class="timeline-body">
                            <p>Suivi régulier de validation du compost</p>
                        </div>
                    </div>
                </li>
                <li>
        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <?php foreach($tAvis as $avis): ?>
                    ...
                    if($avis['category'] == 'Particulier' && $avis['display'] == '1'){?>

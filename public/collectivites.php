<?php //fichier public/collectivites.php
...
<html lang="fr">
<head>
    <title>Collectivités | Les Compagnons du Compost</title>
    <?php include('asset/includes/head.php');
    ?>
    <meta name="description" content="Les Compagnons du compost accompagnent les collectivités dans leurs démarches de compostage avec un suivi personnalisé">
</head>
<body>
<!----HEADER---->
    <header>
...
<!----MAIN---->
    <main>
        <section class="banner">
            <div class="row">
                <h1 class="col-12 display-2 mb-3 display-3 text-center margin-title align-self-center titre">Collectivités</h1>
        ...
        <!----WAVE---->
        <div class="wave">
            <img src="asset/img/waveabout.svg" class="curvy-header" alt="wavy">
        </div>
        <!----WAVE FIN---->
        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <?php foreach($tAvis as $avis): ?>
                    ...
                    if($avis['category'] == 'Collectivite' && $avis['display'] == '1'){?>
                    ...
                    <div class="row justify-content-around mb-5">
                        ...
                        <div class="col-xs-12 col-sm-9 col-md-10 col-lg-6 col-xl-5 texteO order-lg-2 order-1">
                            <div class="avis-block prO col-sm-12 col-md-11 col-lg-10">
                                ...
                                <p class="avis-name text-center">Collectivités</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row col-12">
                ...
                <div class="imgPart">
                    <figure class="thumbnail-height mb-5 col-7 col-md-4 col-lg-6">
                        <img src="asset/img/bge-logo.webp" alt="logo partenaire BGE" title='logo partenaire BGE' class="img-thumbnail rounded-circle">
                    </figure>
                    <figure class="thumbnail-height mb-5 col-7 col-md-4 col-lg-6">
                        <img src="asset/img/agglo-logo.webp" alt="logo partenaire AGGLO" title='logo partenaire AGGLO' class="img-thumbnail rounded-circle">
                    </figure> 
                </div>
            </div>
        </div>
